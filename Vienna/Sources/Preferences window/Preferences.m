...
-(NSDictionary *)allocFactoryDefaults
{
	...
	defaultValues[MAPref_AutoSortFoldersTree] = @(MAFolderSortManual);
    ...
    defaultValues[MAPref_FilterMode] = @(MAFilterModeAll);
    ...
    defaultValues[MAPref_Layout] = @(MALayoutReport);
	defaultValues[MAPref_NewArticlesNotification] = @(MANewArticlesNotificationBadge);
    defaultValues[MAPref_EmptyTrashNotification] = @(MAEmptyTrashWithWarning);
